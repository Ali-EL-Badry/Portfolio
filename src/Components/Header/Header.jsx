        ...
        <>
            <header className={isSticky ? "sticky" : ""} >
                ...
                <div className="nav">
                    ...
                    <div className="nav-icons">
                        <NavLink to="https://github.com/Ali-EL-Badry" className="github" target="_blank"><FaGithub size={40} /></NavLink>
                        <NavLink to="https://www.linkedin.com/in/aly-el-badry/" className="linkedin" target="_blank"><FaLinkedin size={40} /></NavLink>
                    </div>
                </div>
            ...
            <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <div className="nav-icons">
                        <NavLink to="https://github.com/Ali-EL-Badry" className="github" target="_blank"><FaGithub size={30} /></NavLink>
                        <NavLink to="https://www.linkedin.com/in/aly-el-badry/" className="linkedin" target="_blank"><FaLinkedin size={30} /></NavLink>
                    </div></nav>
            </div>
        </>
    );
